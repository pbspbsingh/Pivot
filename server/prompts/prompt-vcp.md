...
{"vcp_score": <float>, "criteria": {"A": {"score": <float>, "reason": "<max 15 words>"}, "B": {"score": <float>, "reason": "<max 15 words>"}, "C": {"score": <float>, "reason": "<max 15 words>"}, "D": {"score": <float>, "reason": "<max 15 words>"}, "E": {"score": <float>, "reason": "<max 15 words>"}, "F": {"score": <float>, "reason": "<max 15 words>"}, "G": {"score": <float>, "reason": "<max 15 words>"}, "H": {"score": <float>, "reason": "<max 15 words>"}, "I": {"score": <float>, "reason": "<max 15 words>"}, "J": {"score": <float>, "reason": "<max 15 words>"}}}
